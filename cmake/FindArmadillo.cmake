# modified Find Armadillo to enable the user to supply a different installation by setting Armadillo_DIR
...
if(DEFINED ENV{Armadillo_DIR})
    message(STATUS "using armadillo from $ENV{Armadillo_DIR}")
    set(ARMADILLO_LIBRARY "$ENV{Armadillo_DIR}/libarmadillo.so")
    set(ARMADILLO_INCLUDE_DIR "$ENV{Armadillo_DIR}/tmp/include")
else()
